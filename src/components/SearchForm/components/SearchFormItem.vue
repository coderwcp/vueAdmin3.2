...
const handleSearchProps = computed(() => {
	...
	if (searchEl === "tree-select") handleProps = { ...searchProps, props: { label, ...searchProps.prop }, nodeKey: value };
	if (searchEl === "cascader") handleProps = { ...searchProps, props: { label, value, ...searchProps.prop } };
	return handleProps;
});
